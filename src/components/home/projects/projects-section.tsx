    ...
    >
      ...
      <div className="grid">
        ...
        {/*   <ProjectItem
          ...
          description={
            <p>
              Website for Latin American <strong>exchange houses</strong>, you
              can preview <strong>conversions in real time</strong> and make the
              exchange instantly.
            </p>
          }
        />
        <ProjectItem
          ...
          description={
            <p>
              ...
              identity, preview <strong>exchange rates</strong> and send money
              to relatives.
            </p>
          }
        />
        <ProjectItem
          ...
          description={
            <p>
              <strong>Cryptographic</strong> lottery/lottery platform, allows
              the purchase of <strong>cryptographic tickets</strong> and win
              prizes on the platform's <strong>own token</strong>.
            </p>
          }
        />
        <ProjectItem
        ...
        <ProjectItem
          ...
          description={
            <p>
              Web platform for distributors of the uPOS app, allows to add and
              manage customers.
            </p>
          }
        />
        ...
        <ProjectItem
          ...
          description={
            <p>
              App intended to be a Wiki about all the Pokemon anime characters,
              you can read their characteristics, images, powers, ships, etc...
            </p>
          }
        /> */}
      </div>
